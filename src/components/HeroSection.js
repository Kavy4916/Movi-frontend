      ...
      <div className={styles.container}>
        <div className={styles.grid_two_section}>
          <div className={heroStyles.hero_content}>
            ...
            <Link href="/movie">
              <button className="font">Explore Movies</button>
            </Link>
          </div>
          <div className={heroStyles.hero_image}>
            <img src={imageUrl} alt={alt} width={500} height={500} />
          </div>
        </div>
      </div>
      <div className={footerStyles["custom-shape-divider-bottom-1702618264"]}>
        <svg
          data-name="Layer 1"
        ...
        >
          <path
            ...
            opacity=".25"
            className={footerStyles["shape-fill"]}
          ></path>
          <path
